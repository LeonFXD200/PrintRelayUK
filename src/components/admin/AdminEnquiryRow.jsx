...
/**
 * Editable admin row for a single quote enquiry. Mirrors AdminJobRow: collapsed
 * summary, expandable detail with contact + project info, file download, an
 * editable status and internal notes. All edits bubble up via onUpdate.
 */
export default function AdminEnquiryRow({ enquiry, onUpdate }) {
  ...
  const status = getEnquiryStatus(draft.status)
  const dirty =
